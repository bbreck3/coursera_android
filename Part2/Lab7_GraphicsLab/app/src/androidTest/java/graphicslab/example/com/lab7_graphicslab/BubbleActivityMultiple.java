...
public class BubbleActivityMultiple extends
	...
	public void testRun() {
		...
		solo.waitForActivity(graphicslab.example.com.lab7_graphicslab.BubbleActivity.class, delay);
		...
		assertEquals("Bubble hasn't appeared", 1, solo.getCurrentViews(graphicslab.example.com.lab7_graphicslab.BubbleActivity.BubbleView.class).size());
		...
		// Assert that a bubble was displayed 
		assertEquals("Second bubble hasn't appeared", 2, solo.getCurrentViews(graphicslab.example.com.lab7_graphicslab.BubbleActivity.BubbleView.class).size());
