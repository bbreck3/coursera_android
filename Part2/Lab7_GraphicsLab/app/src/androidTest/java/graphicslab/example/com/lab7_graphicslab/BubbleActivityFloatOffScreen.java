...
public class BubbleActivityFloatOffScreen extends
	...
	public void testRun() {
		...
		solo.clickOnActionBarItem(graphicslab.example.com.lab7_graphicslab.R.id.menu_single_speed);
		...
		boolean bubbleAppeared = solo.getCurrentViews(
				graphicslab.example.com.lab7_graphicslab.BubbleActivity.BubbleView.class).size() > 0;
